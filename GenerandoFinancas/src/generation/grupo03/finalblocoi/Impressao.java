...
public class Impressao {
	...
	public void Imprimir () {
		...
		System.out.printf("%n%3s %-11S%3s %-8.2f %1s %5.2f %% %s", "|", "RENDA TOTAL", "|", rendaTotal.getRendaTotal(), "|", 100.00, "|");
		...
		System.out.printf("%n%3s %-11S%3s %-8.2f %1s %5.2f %%  %s", "|", "Outros", "|", despesas.getOutros(), "|", despesas.getOutros(), "|");
		System.out.printf("%n%3s------------------------------------", ""); 	
