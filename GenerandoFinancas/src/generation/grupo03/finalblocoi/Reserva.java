	...
	public static void ChamarReserva (double totalRenda, double totalDespesas) {
		...
		if(reserva.equals("sim")) {
			...
			System.out.println("\nQue ótimo! \nTer uma reserva financeira é a melhor maneira de estar"
					...
					+ "\n\nDe acordo com o seu cálculo financeiro, você tem R$" + sobra + " livres por mês,"
			...
			System.out.println("\nSem problemas! Podemos te ajudar com isso.\n" + "\nA reserva financeira pode ser a melhor solução para resolver imprevistos, "
					...
					+ "\ndespesas mensais (seria ainda melhor guardar 100% do valor, quando possível!).");
			
			//Explicar que dá para deixar a outra metade do que sobra como garantia, uma folga caso aconteça algo naquele mês específico
			...
			//Pensar em colocar um complemento do tipo "mesmo que pareça pouco, é importante, vai acumulando ao longo dos
			//meses, etc.
		}
		...
		if(projecao.equals("sim")) {
			...
			System.out.println("\nFizemos uma projeção de 6 meses para você: "
					...
					+ " e estará mais perto de conseguir" + textoObj
			...
			System.out.println("\nTudo bem, vamos te ajudar a sonhar e comecar a estabelecer metas!"
					...
					+ "\nestamos indo. E empregamos aï¿½ï¿½es diárias para chegar neste lugar, ou seja, em nosso estado desejado.");
